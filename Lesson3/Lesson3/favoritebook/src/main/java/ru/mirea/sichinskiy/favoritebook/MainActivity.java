package ru.mirea.sichinskiy.favoritebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void getInfoAboutBook() {
        ...
        intent.putExtra(BOOK_NAME_KEY, "Моя любимая книга: 'Бойцовский клуб'");
        intent.putExtra(QUOTES_KEY, "Цитата: 'Лишь утратив всё до конца, мы обретаем свободу'");
